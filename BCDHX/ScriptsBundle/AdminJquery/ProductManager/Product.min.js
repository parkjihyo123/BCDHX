...
let StatusProduct = [{ Value: 1, Text: "Bình thường" }, { Value: 2, Text: "Hàng mới với" }, { Value: 3, Text: "Hàng bán chạy nhất" }, { Value: 4, Text: "Hàng có deal tốt nhất" }];
...
var ordersStoreImage = new DevExpress.data.CustomStore({
    ...
    insert: function (values) {
        return sendRequest(UrlImageProduct + "/AddProduct", "POST", {
            values: JSON.stringify(values)
        });
    },
    update: function (key, values) {
    ...
    remove: function (key) {
        return sendRequest(UrlImageProduct + "/RemoveProduct", "POST", {
            key: key
        });
    }
});
            ...
            editCellTemplate: function (container, cellInfo) {
                var $ac = $("<div>").dxFileUploader({
                   ...
                   // uploadMode: "useButtons",
                    uploadUrl: UrlUploadImage + "/UploadImage1/id=" + cellInfo.data.ID_Product,
